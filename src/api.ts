 ...
 * Public API interface for Maleficar Manoeuvres module
...
export function registerAPI(components: {
  ...
  (globalThis as any).MaleficarManoeuvres = api;
  logger.info('API registered globally as MaleficarManoeuvres');
}